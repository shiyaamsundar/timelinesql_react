...
const ViewProject=()=> {
    ...
    const CArd=()=>{
        ...
        return (
            ...
            <Link to="/project/editprogress"><button className="btn btn-primary rounded">Edit-Progress</button></Link>    
            </div>   
    ...
    return (
        ...
        <i class="fa fa-free-code-camp pr-3" aria-hidden="true"/><span>project title</span></button>
