...
console.log(match.params.id)
    ...
    const loadinterntask=()=>{
        projecttasks(match.params.id).then(data=>{
            if(data)
            {
    ...
    const CArd=(details)=>{
        ...
        <h5 className="pl-2">{details.details.title}</h5>
                ...
                <div className="row pl-2">
                <span>task descritpin:</span>{details.details.description}
...
export default Internprojecttask
